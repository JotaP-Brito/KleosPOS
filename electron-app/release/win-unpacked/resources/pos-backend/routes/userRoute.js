...
const { getPinStatus, setupPin, login, changePin, getUserData, logout } = require("../controllers/userController");
...
router.route("/change-pin").post(isVerifiedUser, changePin);
