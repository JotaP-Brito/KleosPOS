...
app.use("/api/waiter", require("./routes/waiterRoute"));
app.use("/api/connection-info", require("./routes/connectionInfoRoute"));
app.use("/api/tracking-mode", require("./routes/trackingModeRoute"));
...
const startServer = async () => {
  if (server?.listening) return { server, port: server.address().port };
  await connectDB();
