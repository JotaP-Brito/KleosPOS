...
const Orders = () => {
  ...
  return (
    <section className="bg-[#1f1f1f] h-[calc(100vh-5rem)] flex flex-col">
      ...
      <div className="flex items-center justify-between px-10 py-4 shrink-0">
        ...
        <div className="flex items-center justify-around gap-4">
          ...
          <button
            ...
            className={`text-[#ababab] text-lg ${
              status === "progress" ? "bg-[#383838] rounded-lg px-5 py-2" : "rounded-lg px-5 py-2"
            } font-semibold`}
          >
            Em Andamento
          </button>
          <button
            ...
            className={`text-[#ababab] text-lg ${
              status === "ready" ? "bg-[#383838] rounded-lg px-5 py-2" : "rounded-lg px-5 py-2"
            } font-semibold`}
          >
            Pronto
          </button>
      ...
      {/* Área de scroll com a grelha de pedidos */}
      ...
      {/* Modais renderizados fora da grelha */}
